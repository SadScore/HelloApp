...
public class Task1 {
    public static void main(String[] args) {
        ...
        System.out.println(isObjectHere("красный", colors));// true
        System.out.println(isObjectHere("голубой", colors));// true
        System.out.println(isObjectHere("белый", colors));// true
        System.out.println(isObjectHere("зеленый", colors));// false
    }
